...
function get() {
    ...
    let latmin = lat.value - 2;
    let latmax = parseInt(lat.value) + 3;
    localStorage.setItem("long",lonmax);
    localStorage.setItem("lat",latmin);
...
// MAP CODE
function map(){
    window.location.href("/<repository>/map_original.html");
